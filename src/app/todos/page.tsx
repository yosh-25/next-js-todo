  ...
  return (
    <div className="flex flex-col space-y-10 justify-center items-center mt-10 min-h">
      ...
      <ul className="space-y-3 text-xl w-9/12">
        <li className="flex justify-between border-l-4 pl-3 border-blue-500 bg-white rounded shadow p-3">
            <p className='outline-none' >todo</p>
            <p>status</p>
        </li>
        <li className="flex justify-between space-x-5 border-l-4 pl-3 border-blue-500 bg-white rounded shadow p-3">
            <p className='outline-none' >todo</p>
            <p>status</p>
        </li>
        <li className="flex justify-between space-x-5 border-l-4 pl-3 border-blue-500 bg-white rounded shadow p-3">
